...
//types
import { JoinGameCardPropType } from './types'
import ProgressBar from '@/components/common/progressBar/progressBar'
import { capitalise } from '@/helper/capitalise'


const JoinGameCard = ({ gameName, venueImage, sportName, type, day,
    date,
    time,
    venueName,
    venueArea, numberOfUsers, limit, booking_status, cost_per_head }: JoinGameCardPropType): JSX.Element => {
    ...
    return (
        <div className={styles.container}>
            <div className={classNames(styles['row'], styles['align-start'])}>
                <div className={styles.left}>
                    <Image className={styles.venue} height={182} width={118} alt='venue image' src={venueImage} />
                </div>
                <div className={styles.right}>
                    ...
                    <div className={classNames(styles.row, styles['mb-9'])}>
                        ...
                        <span className={classNames(styles['subtitle'], styles['white2'])}>{day}</span>
                        <div className={styles.dot}></div>
                        <span className={classNames(styles['subtitle'], styles['white2'])}>{date}</span>
                    </div>
                    <div className={classNames(styles.row, styles['mb-9'])}>
                        <div className={classNames(styles['mr-12'], styles.image_container)}>
            ...
            <div className={classNames(styles['borderBottom'], styles['mt-16'], styles['mb-16'])} />
            <div className={classNames(styles.row, styles['mb-9'])}>
                <div className={classNames(styles['mr-12'], styles.image_container)}>
