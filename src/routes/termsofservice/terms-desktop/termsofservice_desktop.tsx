...
//styles
import styles from './termsofservice_desktop.module.scss';
...
const Termsofservice_desktop = () => {
  return (
    <>
      <Navbar_desktop />
      <Top_shadows />
      <div className={styles.terms_desktop_container}>
...
export default Termsofservice_desktop